      ...
      ><v-row>
        <v-col cols="12" sm="4"
          ><v-card-text class="white--text pt-2"
            ><v-btn icon> <v-icon color="#A7121D">Home</v-icon> </v-btn></v-card-text
          ></v-col
        >
        <v-col cols="12" sm="4"
        ...
        <v-col cols="12" sm="4"
          ><v-card-text class="pt-2"
            ...
            Created by Alexander Schatteman
          </v-card-text></v-col
        >
      </v-row>
    </v-card>
...
export default {
  data: () => ({
    icons: ['mdi-facebook', 'mdi-instagram', 'mdi-linkedin', 'mdi-twitter', 'mdi-github'],
  }),
};
</script>
